...
%DIF ADD hafnio_ale.tex                Fri Feb 21 00:02:18 2020
...
The shell-wise local plasma approximation (SLPA) was \DIFdelbegin \DIFdel{employed }\DIFdelend \DIFaddbegin \DIFadd{used }\DIFaddend to describe the energy transferred to the bound 1s-4f electrons, and the outer four electrons were considered as a free electron gas (FEG). 
 ...
 We found the relativistic description of the 4f-shell\DIFaddbegin \DIFadd{, }\DIFaddend and the screening between $4f$ and $5p$ electrons are decisive around the stopping maximum. 
...
The screening \DIFdelbegin \DIFdel{among the $4f$ and $5p$ }\DIFdelend \DIFaddbegin \DIFadd{between the 4f and 5p }\DIFaddend electrons has been considered\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{, and it has been }\DIFaddend found to play a major role within the SLPA \DIFdelbegin \DIFdel{calculations}\DIFdelend \DIFaddbegin \DIFadd{predictions}\DIFaddend .
...
\DIFaddbegin \DIFadd{To asses the importance of the relativistic description of the bound electrons, }\DIFaddend Figure \ref{Binding_E} (a) shows non relativistic and \DIFdelbegin \DIFdel{our }\DIFdelend relativistic binding energies $E_{nl\pm}$, where $\pm=j\pm1/2$.
We compare our results with experimental measurements on solid Hf \cite{williams1995} from $1s$ to $4f_{\pm}$. We notice that not only the \DIFdelbegin \DIFdel{deep }\DIFdelend \DIFaddbegin \DIFadd{most inner }\DIFaddend shells require relativistic calculations, but also the outer $5p$ and $4f$ shells. Figure \ref{Binding_E} (b) \DIFdelbegin \DIFdel{displays }\DIFdelend \DIFaddbegin \DIFadd{presents }\DIFaddend the relative error of non relativistic and relativistic energies with respect to the experimental data in logarithmic scale. This figure shows very clearly the disability of non-relativistic calculations to describe the experimental data, which surprisingly worsens from the inner to the outer shells. 
