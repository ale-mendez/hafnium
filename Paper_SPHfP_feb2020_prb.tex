...
\begin{abstract}
 ...
 Present theoretical and experimental results are in very good agreement in the energy region of the new measurements. However, our theoretical stopping cross sections show %interesting 
 substantial differences with the semi-empirical values by SRIM2013 and ICRU-49 at intermediate to low energies. Our calculations suggest the stopping maximum %around 40 eV$/(10^{15}$ atom/cm$^2)$ at 70 keV, which is
 higher and shifted to lower energies than previous predictions. Future measurements below 100 keV would be decisive for a better knowledge of the stopping maximum and below.
\end{abstract}
